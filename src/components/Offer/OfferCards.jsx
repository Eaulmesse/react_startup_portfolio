...
const OfferCards = ({ title, description }) => {
  ...
  return (
    <motion.div className="max-w-[256px] w-full flex flex-col items-center justify-center bg-neutral-900 p-5 rounded-2xl relative overflow-hidden m-5"  whileHover="hover" initial="initial" variants={parentVariants}>
