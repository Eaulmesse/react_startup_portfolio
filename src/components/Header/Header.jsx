...
const Header = () => {
    ...
    return (
        <header>
            <h1 className='w-4/5 m-auto text-center poppins-bold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text text-4xl md:text-6xl lg:text-7xl py-3 mt-5 lg:mt-20'>Développeur Front-End pour Startups : MVP rapides et interfaces engageantes."</h1>
