...
const Navbar = () => {
    ...
    return (
        <div className='relative'>
            <nav className="flex w-4/5 lg:w-7/12 rounded-[25px] justify-between items-center  py-2 px-5 mt-5 mx-auto bg-gradient-to-r from-zinc-700 to-zinc-800 shadow-md shadow-zinc-800 z-50 relative">
                <p className='poppins-medium text-white drop-shadow-lg'>Théo Guerin.</p>
