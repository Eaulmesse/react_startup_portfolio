...
const BurgerMenu = ({ toggleMenu, onClick }) => {
    return (
        <div className={`lg:hidden   rounded-[25px] left-1/2 -translate-x-1/2  absolute w-4/5 z-40 bg-gradient-to-r from-zinc-700 to-zinc-800 shadow-md shadow-zinc-800 z-50 transition duration-300 py-5 ${toggleMenu ? 'translate-y-[-40px]  opacity-100' : 'translate-y-[-65px]  opacity-0'}`}>
